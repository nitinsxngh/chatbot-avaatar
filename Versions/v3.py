...
from metadata_utils import build_metadata_filter, filter_label
...
def ask(question: str) -> str:
    ...
    if looks_like_injection(question):
        ...
        remember(question, INJECTION_BLOCK_REPLY)
        return INJECTION_BLOCK_REPLY
    ...
    if needs_documents(intent):
        ...
        for attempt in range(1, MAX_RETRIEVAL_ATTEMPTS + 1):
            ...
            band = confidence_band(attempt_score)
            print(
        ...
        if band == "high":
            ...
            # Partial match → ask what they mean / are asking about
            def _clarify() -> str:
            ...
            # Weak match → no relevant information
